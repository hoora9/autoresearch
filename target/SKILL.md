...
description: Transform YouTube transcripts, documentation, processes, and raw instructional content into Hoora-style teaching documents optimized for a general YouTube audience. Produces self-contained, click-by-click walkthrough documents with clear actions, reasoning, and benefits — designed to work without live interaction. Also supports 1-to-1 coaching content. Use this skill when converting transcripts, creating tutorials, building walkthroughs, writing training materials, or producing any educational content. Also trigger when the user mentions "Hoora's style", "coaching style", "teach like Hoora", "walkthrough", "step-by-step guide", "YouTube tutorial", "training document", or asks for content that teaches a general audience how to do something.
---
