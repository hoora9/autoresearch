...
description: >
  Create editable Excalidraw diagrams via the Excalidraw MCP server. Use when someone says
  "draw a diagram", "make an Excalidraw diagram", "build a diagram", "visualize this",
  "diagram this architecture", "show me a flowchart", "create a system diagram", or asks
  for any hand-drawn style editable diagram. Default skill for all diagram requests unless
  the user specifically asks for Mermaid, Canva, or interactive workflow diagrams.
  Do NOT trigger for: interactive drag-and-drop workflow builders (use visual-workflow-builder),
  Canva designs (use canva-designer), Mermaid chart rendering (use Mermaid Chart MCP), or
  Figma design work (use figma-designer).
---
